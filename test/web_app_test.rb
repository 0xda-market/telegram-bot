...
require "json"
require "rack/mock"
require "zero_x_da/telegram_bot/bot_identity"
require "zero_x_da/telegram_bot/http_app"
require "zero_x_da/telegram_bot/web_app"
...
class TelegramBotHTTPAppTest < Minitest::Test
  ...
  def test_bot_identity_is_resolved_from_get_me_once_before_http_requests
    username = ZeroXDA::TelegramBot::TelegramBotIdentity.resolve(
  ...
  def test_invalid_bot_identity_fails_during_boot
    error = assert_raises(ArgumentError) do
      ZeroXDA::TelegramBot::TelegramBotIdentity.resolve(
  ...
  def test_legacy_constants_alias_the_explicit_bot_runtime
    assert_equal ZeroXDA::TelegramBot::TelegramBotHTTPApp, ZeroXDA::TelegramBot::HTTPApp
    assert_equal ZeroXDA::TelegramBot::TelegramBotHTTPApp, ZeroXDA::TelegramBot::WebApp
  end
  ...
  def build_app(username:, dispatcher: ImmediateDispatcher.new, mini_app: nil)
    ZeroXDA::TelegramBot::TelegramBotHTTPApp.new(
      bot: @handler,
