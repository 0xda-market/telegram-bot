...
require "time"
require "zero_x_da/market_client_bot/telegram_web_app_service"

class TelegramWebAppServiceTest < Minitest::Test
  Session = ZeroXDA::MarketClientBot::TelegramWebAppAuth::Session
  ...
  def setup
    ...
    @service = ZeroXDA::MarketClientBot::TelegramWebAppService.new(
      market_api: @market,
